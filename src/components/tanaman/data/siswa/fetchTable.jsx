          ...
          <div className={Style.cardwrapper}>
            <div className="w-full">
              <p className="max-w-full font-bold text-white md:w-[64%] md:leading-[42px] lg:w-[46%] xl:w-[85%] 2xl:w-[75%] 3xl:w-[52%]">
                <span style={{ fontSize: 40 }}>Tanaman</span> <br />
        ...
        >
          ...
          {isContentVisible && (
            <div className="mb-5 -mt-1 flex gap-4">
              <div>
                <span className="bg-orange-100 text-amber-700 rounded px-3 py-2 font-medium">
                  {`Tinggi Toga: 10cm`}
                </span>
              </div>
              <div>
                <span className="bg-lime-100 text-lime-700 rounded px-3 py-2 font-medium">
                  {`Hasil Observasi: Terdapat cacing-cacing kecil berwarna putih-transparan`}
                </span>
              </div>
            </div>
          )}
